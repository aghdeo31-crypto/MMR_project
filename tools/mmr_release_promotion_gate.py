...
def main():
    ...
    add('G5_small_font_family',small_ok,fr.get('small_font_family_status'))

    jp=docs['jp_translation']
    add('G6_japanese_original_translation',
    ...
    add('G7_static_binary_font_diff',
    ...
    out={
      'schema':'MMR_THIRD_ATTEMPT_RELEASE_PROMOTION_V2_SYSTEM_UI_FIRST',
